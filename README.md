👋 Salut à tous,
Bienvenue sur ce dépôt GitHub dédié à mon application KARTENN !
Vous y trouverez plusieurs fonctions Python pouvant être exécutées indépendamment dans la console de QGIS.
